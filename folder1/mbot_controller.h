...
//define pid controller struct
typedef struct mbot_pid_cfg_t {float kp; float ki; float kd; float Tf} mbot_pid_cfg_t;
//define a system ctronller struct with PID controllers
